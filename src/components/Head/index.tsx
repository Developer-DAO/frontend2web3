...
const Head: React.FunctionComponent<IHeadProps> = ({
  ...
  return (
    <NextHead>
      ...
      <meta key="author" name="author" content="Frontend to web3 seo" />
      ...
      />
      <meta key="twitter:creator" name="twitter:creator" content="@rahat" />
      <meta
        key="twitter:title"
        name="twitter:title"
        content={
          title
            ? `${title} | Rahat | Frontend to web3 seo`
            : `Rahat | Frontend to web3 seo`
        }
      />
      <meta
